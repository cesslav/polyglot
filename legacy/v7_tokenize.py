...
from legacy.v7_conf import TransformerConfig
...
def main():
    ...
    # Calculate how many observations are needed for a 20% mixed48k sample
    ...
    # Get the train dataset and the mixed48k dataset
    train_dataset, test_dataset = random_split(
        text_pairs_encoded_padded, [train_len, test_len]
    )

    # Save the mixed48k and train datasets as pickle files
