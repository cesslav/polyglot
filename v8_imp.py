...
if __name__ == '__main__':
    ...
    def count_parameters_and_size(model, dtype_bytes=2):
    ...
    print(count_parameters_and_size(model))

    src = torch.randint(0, 512, (2, 1024))
    src_mask = torch.ones_like(src).bool()
    tgt = torch.randint(0, 512, (2, 1024))
    print(src.size(), src_mask.size(), tgt.size())
